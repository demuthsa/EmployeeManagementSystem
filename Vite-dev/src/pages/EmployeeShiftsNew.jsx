...
export default function EmployeeShiftsNew() {
    ...
    const [shift_id_input, setShiftId] = useState("");
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.post("http://flip3.engr.oregonstate.edu:1819/employeeshifts", {
                employee_id_input, 
                shift_id_input
            });
            console.log(res);
    ...
    return (
        <div>
            <h3>Add New Employee Shift Relationship</h3>
